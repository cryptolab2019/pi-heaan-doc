...
class RotateCopy :
    ...
    def rotate_copy(self, ciphertext, num_vectors, num_slots_per_vec, vector_idx) :
        ...
        mask = heaan.Message(self._pad_z(num_slots_per_vec, num_vectors, vector_idx_per_data))
        ...
        for idx in range(int(log_num_vec_per_data)):
            ...
            evaluator.right_rotate(ctxt_out, rot_idx, public_key_pack, ctxt_tmp)
